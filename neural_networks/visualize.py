...
def compute_ratemaps(model, trajectory_generator, options, res=20, n_avg=None, Ng=512, idxs=None, dtype='float64'):
    ...
    g = np.zeros([n_avg, options.batch_size * options.sequence_length, Ng],dtype=dtype)
